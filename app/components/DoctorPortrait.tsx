...
export function DoctorPortrait({ className = "" }: DoctorPortraitProps) {
  ...
  return (
    <figure className={className}>
      <div className="relative aspect-4/5 overflow-hidden rounded-2xl bg-linear-to-br from-brand-100 via-brand-50 to-accent-100 ring-1 ring-brand-200/70 shadow-[0_20px_60px_-25px_rgba(28,104,103,0.45)]">
        <Image
          src={portrait.photo}
